...
import com.hjsoft.emptransport.activity.RideActivity;
 ...
 */
public class HomeFragment extends Fragment implements RecyclerAdapter.AdapterCallback  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        v=inflater.inflate(R.layout.activity_all_duties, container, false);
        ...
        rView=(RecyclerView)v.findViewById(R.id.aad_rv_list);
        tvNoDuties=(TextView)v.findViewById(R.id.aad_tv_no_duties);
        ibRefresh=(ImageButton) v.findViewById(R.id.aad_ib_refresh);
        ivLogout=(ImageView)v.findViewById(R.id.aad_iv_logout);
        tvTitle=(TextView)v.findViewById(R.id.aad_tv_title);
        ...
        ivLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final View dialogView = inflater1.inflate(R.layout.alert_logout, null);
        ...
        call.enqueue(new Callback<List<EmpPojo>>() {
            ...
            public void onResponse(Call<List<EmpPojo>> call, Response<List<EmpPojo>> response) {
                ...
                if(response.isSuccessful())
                {
                    ...
                    Intent i = new Intent(getActivity(), RideActivity.class);
                    i.putExtra("list", data);
                    i.putExtra("position", position);
